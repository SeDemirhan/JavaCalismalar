 ...
 */
            ...
            System.out.println("***** super object classdan");
             diziYazdirObjcet(intDizi);
             diziYazdirObjcet(doubleDizi);
             diziYazdirObjcet(charDizi);

    }

    private static void diziYazdirObjcet(Object[] dizi) {   //sana her şey gelebilir demis oluyorum int,string...
        Arrays.stream(dizi).forEach(System.out::print);
    }

    //overloadibg method
/*
    private static void diziYazdir(Character[] charDizi) {
        Arrays.stream(charDizi).forEach(System.out::print);
    }

    private static void diziYazdir(Double[] doubleDizi) {
        Arrays.stream(doubleDizi).forEach(System.out::print);
    }
